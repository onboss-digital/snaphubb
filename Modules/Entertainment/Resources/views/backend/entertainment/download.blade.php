                                        ...
                                        <div class="row gy-3 video-inputs-container">
                                            ...
                                            <div class="col-md-6 col-lg-4 video-input">
                                                ...
                                                {{ html()->select(
                                                        ...
                                                        $video_quality->pluck('name', 'value')->prepend(__('placeholder.lbl_select_quality'), ''), $mapping->quality
                                ...
                                @else
                                    <div class="row video-inputs-container">
                                        ...
                                        <div class="col-sm-12 text-end mb-3">
                                            <button type="button" class="btn btn-secondary-subtle btn-sm fs-4 m-2 remove-video-input d-none"><i class="ph ph-trash align-middle"></i></button>
                                        </div>
                                    </div>
                                @endif
                            </div>
