...
<div class="card-main mb-5">
    <x-backend.section-header>
        ...
        <x-backend.quick-action url='{{ route("backend.users.ranking.bulk_action") }}'>
            <div class="">
        ...
        <x-slot name="toolbar">
            ...
            <a href="{{ route('backend.users.ranking.create') }}" class="btn btn-primary d-flex align-items-center gap-1"
...
const columns = [
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            initDatatable({
                url: '{{ route("backend.users.ranking.index_data") }}',
                finalColumns,
                orderColumn: [
                     [5, "desc"]
             ],
