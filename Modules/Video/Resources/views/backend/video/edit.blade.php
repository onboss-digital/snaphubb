                ...
                <div class="row gy-3">
                    ...
                    <div class="col-lg-8">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6 {{ old('access', $data->access) == 'free' ? 'd-none' : '' }}" id="planSelection">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ html()->select('genre_id', $genres->pluck('name', 'id')->prepend(__('placeholder.lbl_select_category'), ''), $data->genre_id)->class('form-control select2')->id('genre_id')}}
                                @error('genre_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
            ...
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6 d-none" id="video_url_input_section">
                        ...
                        {{ html()->text('video_url_input')->attribute('value', $data->video_url_input)->placeholder('YouTube ID: 6kXCKOdovus ou URL: https://youtu.be/6kXCKOdovus')->class('form-control')->id('video_url_input') }}
