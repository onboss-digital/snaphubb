    ...
    public function DashboardDetail(Request $request){
        ...
        $continueWatch = [];
           ...
           $sliders = SliderResource::collection($sliderList->map(function ($slider) use ($user_id) {
            ...
            $topMovies = Entertainment::whereIn('id',json_decode($topMovieIds))->get();
            ...
            $latestMovie = Entertainment::whereIn('id',json_decode($latestMovieIds))->get();
            ...
            $popularMovies = Entertainment::whereIn('id',json_decode($popularMovieIds))->get();
            $popular_movie = CommanResource::collection($popularMovies);



            $channelIds = MobileSetting::getValueBySlug('top-channels');
            $channels = LiveTvChannel::whereIn('id',json_decode($channelIds))->get();
            ...
            $free_movies_tvshow = Entertainment::whereIn('id',json_decode($movieIds))->get();
            ...
            $popular_tvshow = Entertainment::whereIn('id',json_decode($popular_tvshowIds))->get();
            $popular_tvshow = CommanResource::collection($popular_tvshow);



            $genreIds = MobileSetting::getValueBySlug(slug: 'genre');
            $genres = Genres::whereIn('id',json_decode($genreIds))->get();
            ...
            $popular_videos = Video::whereIn('id',json_decode($videoIds))->get();
